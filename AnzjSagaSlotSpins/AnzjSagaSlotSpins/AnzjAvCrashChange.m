...
@implementation AnzjAvCrashChange


+ (void)AnzjbecomeEffective {
    [self effectiveIfDealWithNoneSel:NO];
    
}

+ (void)AnzjmakeAllEffective {
...
+ (void)effectiveIfDealWithNoneSel:(BOOL)dealWithNoneSel {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [NSArray anzj_avoidCrashExchangeMethod];
        [NSMutableArray anzj_avoidCrashExchangeMethod];
        
        [NSDictionary anzj_avoidCrashExchangeMethod];
        [NSMutableDictionary anzj_avoidCrashExchangeMethod];
        
        [NSString anzj_avoidCrashExchangeMethod];
        [NSMutableString anzj_avoidCrashExchangeMethod];
        
        [NSAttributedString anzj_avoidCrashExchangeMethod];
        [NSMutableAttributedString anzj_avoidCrashExchangeMethod];
    });
}

+ (void)AnzjsetupNoneSelClassStringsArr:(NSArray<NSString *> *)classStrings {
    [NSObject AnzjsetupNoneSelClassStringsArr:classStrings];
}
...
+ (void)AnzjsetupNoneSelClassStringPrefixsArr:(NSArray<NSString *> *)classStringPrefixs {
    [NSObject AnzjsetupNoneSelClassStringPrefixsArr:classStringPrefixs];
}
...
+ (void)noteErrorWithException:(NSException *)exception defaultToDo:(NSString *)defaultToDo {
    ...
    NSString *mainCallStackSymbolMsg = [AnzjAvCrashChange getMainCallStackSymbolMessageWithCallStackSymbols:callStackSymbolsArr];
