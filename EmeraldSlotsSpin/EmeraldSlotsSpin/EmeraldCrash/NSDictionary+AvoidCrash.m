...
+ (void)Emerald_avoidCrashExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [EmeraldCrash EmeraldexchangeClassMethod:self method1Sel:@selector(dictionaryWithObjects:forKeys:count:) method2Sel:@selector(avoidCrashDictionaryWithObjects:forKeys:count:)];
    });
}
