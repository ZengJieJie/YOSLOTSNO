...
+ (void)Emerald_avoidCrashExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        //setObject:forKey:
        [EmeraldCrash EmeraldexchangeInstanceMethod:dictionaryM method1Sel:@selector(setObject:forKey:) method2Sel:@selector(avoidCrashSetObject:forKey:)];
        
        //setObject:forKeyedSubscript:
        if (AvoidCrashIsiOS(11.0)) {
            [EmeraldCrash EmeraldexchangeInstanceMethod:dictionaryM method1Sel:@selector(setObject:forKeyedSubscript:) method2Sel:@selector(avoidCrashSetObject:forKeyedSubscript:)];
        }
